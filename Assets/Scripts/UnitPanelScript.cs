...
public class UnitPanelScript : MonoBehaviour
{
    ...
    Color DeadColor = new Color(1f, 90f / 255f, 50f / 255f);
    ...
    //NEEDS TO BE UPDATED 
    public void UpdateBackground(ActionState state) //changes panel background based on its current state
    {
        switch (state)
        {
            ...
            case ActionState.Dead:
                IconBackground.color = DeadColor; // optional
                break;
        }
